...
class Feeder(Dataset):
    def __init__(self, data_path, num_cls, data_type='j', repeat=1):
        ...
        self.left_arm = np.array([1, 3, 5, 10, 11, 12, 13])
        self.right_arm = np.array([2, 4, 26, 31, 32, 33, 34])
        self.finger1 = np.array([7, 8, 9, 14, 15, 16, 17])
        self.finger2 = np.array([18, 19, 20, 21, 22, 23, 24, 25])
        self.finger3 = np.array([28, 29, 30, 35, 36, 37, 38])
