...
from model.GAN import GraphAttentionLayer4D
...
class VSNet(nn.Module):
    def __init__(self, in_channels=3, channels=(96, 192, 192, 192), num_classes=60,
        ...
        self.l1 = GraphAttentionLayer4D(in_channels, 64, 0, 0.2)
        self.l2 = GraphAttentionLayer4D(64, embed_dim, 0, 0.2)
        self.l3 = GraphAttentionLayer4D(embed_dim, embed_dim, 0, 0.2)
